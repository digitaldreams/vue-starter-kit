<script setup>
import ContactUsFormForm from '@/components/home/ContactUsForm.vue';
</script>
<template>
  <div class="container mx-auto">
    <h2 class="text-3xl text-center p-10 shadow shadow-slate-100">
      Contact Us
    </h2>
    <p class="p-5 text-center text-2xl font-light">
      Contact us with now to get a customize quotation of your dream project
    </p>
    <div class="md:grid md:grid-cols-5">
      <div class="my-5 p-3 col-span-2">
        <div class="flex mb-5">
          <div class="h-12 w-12 flex-none bg-gray-100 rounded-full mr-2"></div>
          <div class="p-2">
            Dummy Streat, Dummy House, Dummy City,Town, 1212, Country
          </div>
        </div>

        <div class="flex mb-5">
          <div class="h-12 w-12 flex-none bg-gray-100 rounded-full mr-2"></div>
          <div class="p-3">+ 1 000 000 0000</div>
        </div>
        <div class="flex mb-5">
          <div class="h-12 w-12 flex-none bg-gray-100 rounded-full mr-2"></div>
          <div class="p-3">contact@example.com</div>
        </div>
        <div class="flex">
          <a class="flex justify-center items-center w-12 h-12 mr-4 bg-gray-50 rounded-full" href="#">
            <svg class="text-gray-500" width="7" height="12" viewBox="0 0 7 12" fill="none"
          ...
          <a class="flex justify-center items-center w-12 h-12 mr-4 bg-gray-50 rounded-full" href="#">
            <svg class="text-gray-500" width="13" height="11" viewBox="0 0 13 11" fill="none"
              xmlns="http://www.w3.org/2000/svg">
              <path fill-rule="evenodd" clip-rule="evenodd"
          ...
          <a class="flex justify-center items-center w-12 h-12 mr-4 bg-gray-50 rounded-full" href="#">
            <svg class="text-gray-500" width="14" height="14" viewBox="0 0 14 14" fill="none"
              xmlns="http://www.w3.org/2000/svg">
              <path fill-rule="evenodd" clip-rule="evenodd"
          ...
          <a class="flex justify-center items-center w-12 h-12 bg-gray-50 rounded-full" href="#">
            <svg class="text-gray-500" width="12" height="12" viewBox="0 0 12 12" fill="none"
              xmlns="http://www.w3.org/2000/svg">
              <path
